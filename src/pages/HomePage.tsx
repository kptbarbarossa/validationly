        ...
        <>
            ...
            <div className="relative mb-0" >
                ...
                <div className="relative z-10 py-8">
                    ...
                    {/* Auto Google Login Section - Only show if user is not logged in */}
                    {!user && (
                        <div className="animate-slide-up delay-400">
                            <div className="bg-gradient-to-r from-indigo-500/10 to-cyan-500/10 backdrop-blur-sm rounded-2xl p-6 border border-indigo-500/20 max-w-md mx-auto">
                                <div className="text-center mb-4">
                                    ...
                                    <p className="text-slate-300 text-sm">
                                        Sign in with Google to start validating your ideas
                                    </p>
                                </div>
                                ...
                                <button
                                    ...
                                    className="w-full bg-white text-gray-900 font-medium py-3 px-4 rounded-xl hover:bg-gray-100 transition-all duration-200 flex items-center justify-center gap-3 shadow-lg hover:shadow-xl"
                                >
