    ...
    return (
        <>
            ...
            <div className="text-center max-w-4xl mx-auto text-slate-100">
                        ...
                        <div className="flex items-start space-x-3">
                            ...
                            <div className="flex-shrink-0">
                                <div className="w-10 h-10 rounded-lg flex items-center justify-center p-2 bg-white">
                                    <img
                                        src="https://notion.so/favicon.ico"
                                        alt="Notion Logo"
                                        className="w-full h-full object-contain"
                                        onError={(e) => {
                                            // Fallback to text logo if image fails
                                            ...
                                            const parent = target.parentElement;
                                            if (parent) {
                                                parent.className = "w-10 h-10 bg-gradient-to-br from-gray-900 to-black rounded-lg flex items-center justify-center";
                                                parent.innerHTML = '<span class="text-white font-bold text-sm">N</span>';
                                            }
                                        }}
                                    />
                                </div>
                            ...
                            <div className="flex-1">
                                <div className="flex items-center space-x-2 mb-1">
                                    <h3 className="text-base font-bold text-white">Notion</h3>
                                ...
                                <p className="text-gray-300 text-xs mb-3 leading-relaxed">
                                    ...
                                    Perfect for organizing your startup journey.
                                </p>
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="nofollow noopener"
                                    className="inline-flex items-center space-x-1 px-3 py-1.5 bg-gradient-to-r from-gray-800 to-gray-900 text-white rounded-lg hover:shadow-lg transition-all transform hover:scale-105 text-xs font-medium"
                                >
                                    <span>📝</span>
                ...
                {/* Vercel Affiliate Card */}
                <div className="mt-6 mb-6">
                    <div className="bg-gray-800/50 backdrop-blur rounded-2xl p-4 border border-white/10 max-w-lg mx-auto">
                        <div className="flex items-start space-x-3">
                            {/* Logo */}
                            <div className="flex-shrink-0">
                                <div className="w-10 h-10 rounded-lg flex items-center justify-center p-2 bg-black">
                                    <img
                                        ...
                                        onError={(e) => {
                                            ...
                                            if (parent) {
                                                parent.className = "w-10 h-10 bg-gradient-to-br from-gray-900 to-black rounded-lg flex items-center justify-center";
                                                parent.innerHTML = '<span class="text-white font-bold text-sm">▲</span>';
                                            }
                                        }}
                                    />
                                </div>
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-gray-300 text-xs mb-3 leading-relaxed">
                                    Deploy your frontend instantly with zero configuration.
                                    Perfect for React, Next.js, and static sites.
                                </p>
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="nofollow noopener"
                                    className="inline-flex items-center space-x-1 px-3 py-1.5 bg-gradient-to-r from-gray-800 to-black text-white rounded-lg hover:shadow-lg transition-all transform hover:scale-105 text-xs font-medium"
                                >
                                    <span>⚡</span>
